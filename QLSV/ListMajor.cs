...
namespace QuanLySinhVien
{
    ...
    public class ListMajor : ISerializable
    {
        ...
        private void InitializeSampleData()
        {
            ...
            // Hàm tiện ích thêm Course vào Major
            ...
            // CNTT01
            Major cntt01 = factory.Create("CNTT01", "Công nghệ thông tin Kinh doanh", cntt);
            ...
            // CNTT02
            Major cntt02 = factory.Create("CNTT02", "Hệ thống thông tin", cntt);
            ...
            // TCNH01
            Major tcnh01 = factory.Create("TCNH01", "Tài chính doanh nghiệp", tcnh);
            AddCourseToMajor("EC01", tcnh01);
            AddCourseToMajor("MA01", tcnh01);
            tcnh.Majors.Add(tcnh01);

            // QTKD01
            Major qtkd01 = factory.Create("QTKD01", "Quản trị Marketing", qtkd);
            AddCourseToMajor("MK01", qtkd01);
            AddCourseToMajor("EC01", qtkd01);
            qtkd.Majors.Add(qtkd01);

            // QTKD02
            Major qtkd02 = factory.Create("QTKD02", "Quản trị Nhân lực", qtkd);
