...
namespace QuanLySinhVien
{
    ...
    public class ListMajor : ISerializable
    {
        ...
        // Tính tổng học phí của một ngành
        ...
        private void InitializeSampleData()
        {
            ...
            // Nếu đã có Department và Majors → bỏ qua
            ...
            // Lấy reference đến các Department
            ...
            // ====== Tạo và thêm Major vào Department ======
            ...
            cntt.Majors.Add(cntt01); // ✅ Thêm vào Department
