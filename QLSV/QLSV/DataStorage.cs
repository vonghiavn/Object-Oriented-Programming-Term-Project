...
#pragma warning restore SYSLIB0011
        ...
        {
            var departments = ListDepartment.GetInstance().ListDepartments;
            var courses = ListCourse.GetInstance().ListCourses;

            // Gắn lại các liên kết từ Course → Major
            ...
            // Gắn lại liên kết từ Major → Department (vì Major đã được serialize)
